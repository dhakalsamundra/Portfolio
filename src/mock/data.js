...
export const aboutData = {
  ...
  paragraphTwo:
    ' Skill set of TypeScript, React, React Native, GraphQL, Redux, ContextAPI, Material-UI, Materialize in frontend, Node, Express, MongoDB, Postgress, MySQL in backend & Dockerize, Bash Scripting, AWS & CI/CD in Devops side, Testing with Jest and Cypress, with the basic knowledge on Java, C & C++.',
};
